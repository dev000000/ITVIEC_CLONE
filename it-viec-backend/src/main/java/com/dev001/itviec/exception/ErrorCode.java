...
public enum ErrorCode {
    ...
    JOB_DOMAIN_NOT_FOUND(1122, "Job domain not found", HttpStatus.NOT_FOUND),
    JOB_DOMAIN_NAME_EXISTED(1123, "Job domain name already existed", HttpStatus.BAD_REQUEST),
    JOB_DOMAIN_IN_USE(1124, "Job domain is in use, deprecate manually after migration", HttpStatus.CONFLICT),
    JOB_DOMAIN_DEPRECATED(1125, "Job domain is deprecated", HttpStatus.BAD_REQUEST),
    INDUSTRY_NOT_FOUND(1126, "Industry not found", HttpStatus.NOT_FOUND),
    INDUSTRY_NAME_EXISTED(1127, "Industry name already existed", HttpStatus.BAD_REQUEST),
    INDUSTRY_IN_USE(1128, "Industry is in use, deprecate manually after migration", HttpStatus.CONFLICT),
    INDUSTRY_DEPRECATED(1129, "Industry is deprecated", HttpStatus.BAD_REQUEST),
    JOB_DOMAIN_REQUIRED(1130, "Job domain must not be null", HttpStatus.BAD_REQUEST),
    JOB_DOMAIN_NAME_REQUIRED(1131, "Job domain name must not be blank", HttpStatus.BAD_REQUEST),
    INDUSTRY_NAME_REQUIRED(1132, "Industry name must not be blank", HttpStatus.BAD_REQUEST),
    ...
    JOB_EXPIRES_AT_STILL_IN_PAST(
            1205, "expires_at is still in the past; provide a future date to repost", HttpStatus.BAD_REQUEST),
